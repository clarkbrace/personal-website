...
const PersonalSummary = () => {
  return (
    <div className="flex flex-col w-1/2 p-10">
      <h1 className="text-lg justify-center text-center p-1">
        Personal Summary
      </h1>
      <p>
      ...
      <p>
        <br />I am now an aspiring software engineer and always excited to learn
        new skills and work on fun projects. I am using this website as a mean
        to show off what I have been working on be it video games, pixel art, or
